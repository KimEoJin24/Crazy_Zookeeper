...
public class EnemyBaseState_Stage2 : IState
{
    protected EnemyStateMachine_Stage2 stateMachine;

    protected readonly PlayerGroundData groundData;
    public EnemyBaseState_Stage2(EnemyStateMachine_Stage2 ememyStateMachine)
    {
    ...
    {
        return (stateMachine.Enemy.transform.position - stateMachine.Enemy.transform.position).normalized;
    }
